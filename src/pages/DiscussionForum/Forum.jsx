      ...
      >
        ...
        >
          <Discussion
            ...
            voteUp={() => voteUp(modal.key)}
            downVote={() => downVote(modal.key)}
        ...
        <List
          ...
          renderItem={(item, key) => (
            <List.Item
              key={item.title}
              actions={[
                <div style={{ marginLeft: 60 }} onClick={() => openModal1(item, key)}>
                  <IconText
                ...
                <div>
                  <IconText icon={StarOutlined} text="12" key="list-vertical-like-o" />
                </div>,
                <div>
                  <IconText icon={InstagramOutlined} key="list-vertical-like-o" />
                </div>,
                <div>
                  <IconText icon={TwitterOutlined} key="list-vertical-like-o" />
                </div>,
                <div>
                  <IconText text="Report" key="list-vertical-like-o" />
                </div>,
              ]}
            >
              <Row>
                <Col span={1}>
                  <img
                    ...
                    src="https://static.thenounproject.com/png/341249-200.png"
                    width="30px"
                    onClick={() => voteUp(key)}
                    alt="Vote Up"
                  />
                  ...
                  <img
                    className="image-vote"
                    src="https://static.thenounproject.com/png/341237-200.png"
                    width="30px"
                    alt="Down vote"
                    onClick={() => downVote(key)}
                  />
                </Col>
                <Col span={23}>
                  <List.Item.Meta
