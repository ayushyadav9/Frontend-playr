...
import UpdateMatch from "../../components/Organizer/UpdateMatch";
              ...
              <div class="flex flex-col sm:flex-row mt-10">
                ...
                <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                  ...
                  <span class="flex items-center m-10">
                    <span class="text-gray-600 font-medium text-center m-auto">
                      {details.start.split("/")[0]} {details.start.split("/")[1]}{" "}
                      {details.start.split("/")[2]} - {details.end.split("/")[0]}{" "}
                      {details.end.split("/")[1]} {details.end.split("/")[2]}
                    </span>
                  </span>
                  <UpdateMatch match={details.matches} />
                </div>
              </div>
            </div>
          </div>
